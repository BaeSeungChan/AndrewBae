...
public class PagingBean {
	...
	/**
	 * 페이지당 게시물 수 : 한 페이지에 보여줄 게시물 최대 수
	 */
	private int postCountPerPage = 5;
	
	/**
	 * 페이지그룹 당 페이지 수 : 목록페이지 하단부에 제공할 페이지 수
	 */
	...
	public int getStartRowNumber() {
		int startNum = (nowPage-1) * postCountPerPage +1;
		return startNum;
	}
	...
	/**
	 ...
	 public int getEndRowNumber() {  
		 int count = nowPage*postCountPerPage;
		 if(count > totalPostCount)
	 ...
	 public int getTotalPageGroup() {  
	  ...
	  if(totalPostCount%pageCountPerPageGroup == 0)
		  totalPageGroup = getTotalPage()/pageCountPerPageGroup;
		  //totalPageGroup = totalPostCount/postCountPerPage/pageCountPerPageGroup;
	  else
		  totalPageGroup = getTotalPage()/pageCountPerPageGroup+1;
		  //totalPageGroup = totalPostCount/postCountPerPage/pageCountPerPageGroup+1;
